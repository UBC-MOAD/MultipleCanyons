...
def profiler_08aug(time_conduino):
    # Input
    filename = '/ocean/kramosmu/MultipleCanyons/lab/Conduino/scripts/profiler_tracking_08aug19.txt'
    df = pd.read_csv(filename, delim_whitespace=True, header=1)
    ini = 0
    ...
    time = time_p[0:]-ini_time
    position = ydist[0:]-top_pos
